# html-generator-v9 — Auxiliary Files Pack

> Auxiliary files for `html-generator-v9` — Document Archetype release (2026-08-25):
> ★ v9: **Pattern Q Transaction Document Archetype** (list/wizard 5 steps/view tabs/PDF/sign/DOA modals — locked to F-SALES-SO)
> · **B2 v2 Line Editor** re-locked to SO (grid compact + lean advanced row + discount/VAT engine) · **Pattern P Planner/Scheduler**
> · Iron Rules #98–#101 · audit `doc_archetype` · references/document-archetype/ + references/planner/ — base เดิม v8:
> ★ v8: #95 Overlay Portal (portalMenu แก้ dropdown จม) · #96 List Full-Height (.page-fill)
> · #97 Responsive Desktop-Base (768 adaptive) · #94.1 Cascade Clear · #67.1 Hint Opt-in ·
> #47.1 Stepper Geometry Lock — base เดิม v7:
...
> Lineage: html-generator-25 → v3.x → v4.x → v6 → v7 → v8 → **v9**.
...
### As html-generator-v9 skill author:

1. Place these files alongside `SKILL.md` in `/mnt/skills/user/html-generator-v9/`:
   ```
   /mnt/skills/user/html-generator-v9/
...
**Status:** ✅ Ready for review and integration into `/mnt/skills/user/html-generator-v9/`
