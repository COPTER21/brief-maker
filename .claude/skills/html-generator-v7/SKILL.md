---
name: html-generator-v7
description: >
  สร้าง Production-Ready HTML Prototype มาตรฐาน 2BSimple จาก input อะไรก็ได้ — FRD Pack,
  Feature Brief, BRD, screenshot, requirement text. ★ v7 แทน html-generator-v6/v5/v4 — CI CUBE
  Warm Light (Ivory/Charcoal/Red #FF3B30/Orange #FF9A1F), Satoshi + Noto Sans Thai, vanilla JS.
  Patterns A-O + ★ B2 Document Line Editor (grid 8 คอลัมน์ + VAT 3 โหมด + WHT/ส่วนลดท้ายบิล +
  totals + hard control — บังคับทุกเอกสารธุรกรรม PR/PO/QT/SO/GRN/INV/CN) + ★ Iron Rule #94
  Master Combobox (field ที่อ้าง master = search dropdown pattern เดียวเสมอ) + iron rules ครบ
  #1-94. Drawer 920/680 + .wide 1290 (B2). ใช้เมื่อ user พูดถึง "สร้าง HTML", "HTML จาก FRD
  Pack/Brief", "html-generator-v7", "html-generator-v6", "html-generator", "HTML prototype",
  "HTML mockup", "HTML production ready", "line editor", "รายการสินค้า", "search dropdown
  master", "sidebar shell". Output: 1 ไฟล์ .html single-file SPA เปิดใน browser ทันที.
---

# HTML Generator v7.0 — CUBE Warm Light Edition
...
- [ ] Body has min-width: 1180px (admin desktop-only) ✅/❌
