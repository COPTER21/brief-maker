...
> **Source of Truth (v6):** FRD 01_UI §1.0 Layout Decision Log (Design Authority = frd-generator-v6 Phase 1.5) + pattern ความหมายจาก html-generator-v6 (Sync Read)
> ใน FRD 01_UI.md **copy ID ตรง ๆ จาก BRD** — ห้ามตัดสินใจ Layout ใหม่

### Layout Patterns (from html-generator-v6 — A-N, อ่านสดทุก session)
