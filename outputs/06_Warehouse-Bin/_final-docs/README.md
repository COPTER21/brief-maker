# Warehouse & Bin — Final Documents

เอกสารส่งมอบของ feature `F-LOCATION-MASTER-001` จัดตามลำดับ WF-01 เช่นเดียวกับ `outputs/05_BOM/_final-docs`

## โครงสร้าง

| ลำดับ | โฟลเดอร์ | เนื้อหา |
|---|---|---|
| 00 | `00_context/` | PREBRIEF และ FUNCTION_CHECKLIST ต้นทาง |
| 01 | `01_prototype/` | HTML prototype |
| 02 | `02_qc/` | UX report, coverage report และ E2E test script |
...
1. `08_tldr/tldr-warehouse-bin.html`
