...
- Start: OPEN `./FRD_F-VENDOR_Pack/07_LOCKED_DECISIONS.md`
- ชุดข้อมูล: —
...
- Start: OPEN `./FRD_F-VENDOR_Pack/00_OVERVIEW.md`
- ชุดข้อมูล: —
...
- Start: OPEN `./vendor.html#/vendors`
- ชุดข้อมูล: —
...
- actor (role): AI document reviewer
- Setup: role=document-reviewer · seed=workspace `_final-docs` · files=—
- Start: OPEN `./`
- ชุดข้อมูล: —
...
| # | Action | Input | Expected | Result |
|---|---|---|---|---|
| 1 | OPEN `./` | — | พบ `vendor.html`, FRD Pack, UI Brief, Test Case MD และ QA-friendly HTML | ☐ |
