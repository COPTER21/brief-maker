...
| LOCK-03 | `outputs/F-VENDOR/vendor.html` ล่าสุดเป็น UI source of truth | ผู้ใช้ตรวจและอนุมัติ HTML ก่อนขอสร้างเอกสารต่อ | ✅ applied |
...
- **Date:** 2026-07-31
- **Decision:** route, surfaces, action visibility, UI state และ microcopy ยึด `outputs/F-VENDOR/vendor.html`
