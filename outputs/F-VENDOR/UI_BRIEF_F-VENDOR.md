...
> ทุกข้ออ้างอิง `vendor.html:Lx` หมายถึงบรรทัดใน `outputs/F-VENDOR/vendor.html`
...
| HTML source of truth | `outputs/F-VENDOR/vendor.html` · 1,541 lines · user-approved + sync revision |
| FRD pair | `outputs/F-VENDOR/FRD_F-VENDOR_Pack/` v1.1 sync |
