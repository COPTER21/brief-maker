...
เอกสาร Markdown สำหรับ AI browser/API test agent ทดสอบ F-05 แบบอิสระต่อเคส โดยใช้ `../01_prototype/sales-territory.html` เป็นแหล่ง route และข้อความบนจอ และใช้ FRD เป็น production contract. ห้ามตีความ fixture ของห้า future modules ว่าเป็น integration จริง
...
| Sources | ../04_frd/FRD_F-05_Pack 7/7, ../03_brd/BRD_Sales_Territory.md, ../01_prototype/sales-territory.html, ../05_ui-brief/UI_BRIEF_Sales_Territory.md |
