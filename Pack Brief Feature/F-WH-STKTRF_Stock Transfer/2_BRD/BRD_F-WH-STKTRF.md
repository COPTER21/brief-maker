...
| **Version** | 1.0 |
| **วันที่** | 2026-09-10 |
| **สถานะ** | Phase A — รอทีม vibe HTML แล้วเข้า Phase B |
| **Input ที่ใช้** | `PREBRIEF_F-WH-STKTRF.md` · `FUNCTION_CHECKLIST_F-WH-STKTRF.md` (61 FN) · `BASELINE_F-WH-STKTRF.md` · **HTML prototype `1_HTML/F-WH-STKTRF.html` (ผ่าน UX/Coverage/Tech gate)** · 5 declaration briefs |
