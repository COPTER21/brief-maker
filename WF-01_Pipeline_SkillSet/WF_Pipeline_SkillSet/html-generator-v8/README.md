# html-generator-v8 — Auxiliary Files Pack

> Auxiliary files for `html-generator-v8` — consolidated release (2026-08-09):
...
> Lineage: html-generator-25 → v3.x → v4.x → v6 → v7 → **v8**.
...
### As html-generator-v8 skill author:

1. Place these files alongside `SKILL.md` in `/mnt/skills/user/html-generator-v8/`:
   ```
   /mnt/skills/user/html-generator-v8/
...
**Status:** ✅ Ready for review and integration into `/mnt/skills/user/html-generator-v8/`
