...
description: >
  ...
  frd-generator-v6 หรือ html-generator-v9 กับ feature ที่มี action อนุมัติ/เซ็น แม้ไม่เรียกชื่อ skill
...
FRD Pack                       ├─→ DOA_BRIEF_[F-xxx].md   ← output เดียวของ skill นี้
      ↓                        │
html-generator-v9 ←──── ★ doa-declaration (Sync Read: §HTML Injection)
      ↓
HTML prototype
      ↓
