...
- sidebar charcoal — CI Warm Light ตาม html-generator-v9 (`assets/template.html` sync token จาก
  `html-generator-v9/knowledge/ci-tokens.md` — ถ้า v6 อัพเดต CI ต้อง sync template ตาม, ห้ามแก้สีเอง),
