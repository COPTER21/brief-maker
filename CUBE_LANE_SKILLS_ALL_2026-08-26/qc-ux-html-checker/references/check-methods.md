...
| audit.sh `Rule #104` WARN (sidebar hrefs แชร์ segment แรก >1) | feature เดียวแตกเป็นหลายเมนู | BLOCK #104 ถ้าเป็น feature เดียวกัน · ผ่านถ้าเป็นคนละ feature ตาม catalog |
