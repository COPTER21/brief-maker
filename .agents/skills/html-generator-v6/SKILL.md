---
name: html-generator-v6
description: >
  สร้าง Production-Ready HTML Prototype มาตรฐาน 2BSimple จาก input อะไรก็ได้ — FRD Pack (v4-v6),
  Feature Brief, BRD, screenshot, requirement text. ★ v6 แทน html-generator-v4/v3 — CI ใหม่
  CUBE Warm Light (Ivory #FAF8F5, Charcoal #111111, Red #FF3B30 action, Orange #FF9A1F connection),
  Satoshi + Noto Sans Thai, Lucide, vanilla JS. Patterns A-N (list/drawer/dashboard/report/kanban/
  landing + N sidebar-nav-shell 3 ระดับ + icon rail) + 49 iron rules + Layout Integrity #50-60 (รวม minimal scrollbar 5px)
  + fixed tokens + microcopy. Drawer v2 920/680 (NOT modal). Pipeline Mode รับ FRD Pack /
  Standalone รับทุก input. ใช้เมื่อ user พูดถึง "สร้าง HTML", "HTML จาก FRD Pack/Brief",
  "html-generator-v6", "html-generator-v5", "html-generator", "HTML prototype", "HTML mockup",
  "interactive HTML", "HTML production ready", "HTML CI ใหม่", "sidebar shell".
  Output: 1 ไฟล์ .html single-file SPA, hash routing, เปิดใน browser ทันที — Dev plug API ต่อได้เลย.
---

# HTML Generator v6.0 — CUBE Warm Light Edition
...
| `knowledge/iron-rules.md` | All 49 Iron Rules consolidated |
