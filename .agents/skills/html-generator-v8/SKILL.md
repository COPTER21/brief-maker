---
name: html-generator-v8
description: >
  สร้าง Production-Ready HTML Prototype มาตรฐาน 2BSimple จาก input อะไรก็ได้ — FRD Pack,
  Feature Brief, BRD, screenshot, requirement text. ★ v8 แทน html-generator-v7/v6/v5 — CI CUBE
  Warm Light (Ivory/Charcoal/Red #FF3B30/Orange #FF9A1F), Satoshi + Noto Sans Thai, vanilla JS.
  Patterns A-O + B2 Document Line Editor (บังคับทุกเอกสารธุรกรรม PR/PO/QT/SO/GRN/INV/CN) +
  Iron Rules #1-97: #94 Master Combobox, ★ v8 ใหม่ — #95 Overlay Portal (แก้ dropdown จม),
  #96 List Full-Height (ตารางติดขอบล่าง), #97 Responsive Desktop-Base (768-1180 adaptive),
  #94.1 Cascade Clear, #67.1 Hint Opt-in, #47.1 Stepper Geometry. Drawer 920/680 + .wide 1290.
  ใช้เมื่อ user พูดถึง "สร้าง HTML", "HTML จาก FRD Pack/Brief", "html-generator-v8",
  "html-generator-v7", "html-generator-v6", "html-generator", "HTML prototype", "HTML mockup",
  "HTML production ready", "line editor", "รายการสินค้า", "search dropdown master",
  "sidebar shell". Output: 1 ไฟล์ .html single-file SPA เปิดใน browser ทันที.
---

# HTML Generator v8.0 — CUBE Warm Light Edition
...
[Phase 1] Plan
    ...
    - Map pages → patterns (A-O) + matched variants from design system
    │
    ▼
...
| **เอกสารมี line items + ยอดรวม (PR/PO/QT/SO/GRN/INV/CN/DN/RTV)** | **B2 (ส่วนขยายของ B — locked to line-editor reference)** | `patterns/B2_document-line-editor.md` |
...
**Lazy-load:** อ่านเฉพาะ pattern ที่ feature ใช้จริง (ไม่ใช่ทั้ง 15)
...
**ถ้า feature มี line items → ต้องอ่าน `patterns/B2_document-line-editor.md` ต่อทันที** ห้ามออกแบบตารางกรอกรายการเอง
...
| `patterns/B2_document-line-editor.md` | 🆕 **Line editor: grid 8 คอลัมน์ + VAT 3 โหมด + WHT/ส่วนลดท้ายบิล + totals + hard control — บังคับทุกเอกสารธุรกรรม** (reference: `references/drawer-standard/_SOURCE_line-editor-reference.html` + `line-editor.css.html` + `line-editor.js.txt`) |
| `references/drawer-standard/master-combobox.js.txt` | 🆕 **Master combobox canonical (Rule #94)** — search dropdown สำหรับทุก field ที่อ้าง master |
...
| `knowledge/iron-rules.md` | Iron Rules consolidated (#1–#49 + #94 Master Combobox) |
