...
### หลักการ
Admin tool ของ CUBE NATIVE ออกแบบสำหรับ **desktop-only** (body has `min-width: 1180px`) — บนจอกว้าง (1920px / 2560px / 4K) ต้องใช้พื้นที่ horizontal ให้คุ้ม **ไม่** capped ที่ค่าใดค่าหนึ่ง.
