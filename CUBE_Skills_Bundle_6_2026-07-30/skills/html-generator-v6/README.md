# html-generator-v6 — Auxiliary Files Pack

> Auxiliary files for `html-generator-v6` — consolidated release (2026-07-09):
> v4 base + CUBE Design System CI (Warm Light: Ivory/Charcoal/Red/Orange, Satoshi + Noto Sans Thai)
> + Pattern N Sidebar Navigation Shell + Iron Rule #49 Minimal Scrollbar.
> Lineage: html-generator-25 → v3.x → v4.x → **v6**.
...
### As html-generator-v6 skill author:

1. Place these files alongside `SKILL.md` in `/mnt/skills/user/html-generator-v6/`:
   ```
   /mnt/skills/user/html-generator-v6/
...
**Status:** ✅ Ready for review and integration into `/mnt/skills/user/html-generator-v6/`
